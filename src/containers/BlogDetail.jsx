...
export const BlogDetail = () => {
    ...
    const { title, imageUrl, content, autor, createdAt, imageBackground } = dataBlog;
    const getBlog = async () => {
        const result = await fetch(`${uriServer}/blogs/${params.title}`, {
            method: "GET",
            headers: {
        ...
        const comentarios = await fetch(`${uriServer}/comentarios/${data._id}`, {
            method: "GET",
            headers: {
                "Content-Type": "application/json",
            },
            ...
            <section className="bg-[#222831]">
                ...
                <div className="flex flex-col items-center gap-10 p-5 pt-10 lg:px-36">
                    ...
                    <div className="flex flex-col gap-5">
                        ...
                        <CardNewComentario id_padre={dataBlog?._id} title={params.title}/>
                        {
                            comentarios.map((comentario) => {
                                return <CardComentarios key={comentario._id} {...comentario} />
                            })
                        }
